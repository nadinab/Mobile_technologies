...
public class MainActivity extends Activity {
    ...
    void fillData() {
        for (int i = 1; i <= 2; i++) {
            products.add(new Product("Abbadon " + i, i * 1000,
                    R.drawable.a1, false));
            products.add(new Product("Ancient Apparation " + i, i * 1000,
                    R.drawable.mers, false));
            products.add(new Product("Alcheamick " + i, i * 1000,
                    R.drawable.haval, false));
            products.add(new Product("Undrlord " + i, i * 1000,
                    R.drawable.bomba, false));
            products.add(new Product("Antimage " + i, i * 1000,
